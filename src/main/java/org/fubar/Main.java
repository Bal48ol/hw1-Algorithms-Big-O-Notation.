...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for (int age = 15; age <= 100; age++) {
            MyList<Person> studentsOver14 = personAgeDataGroups.getPersons(age);
        ...
        try (Scanner scanner = new Scanner(System.in)){
            ...
            MyList<Person> studentsWithLastName = personNameDataGroup.getPersons(lastName.charAt(0));
    ...
    private static double averageMark(MyList<Person> ClassStudents){
        int totalMarks = 0;
        int totalStudents = 0;
